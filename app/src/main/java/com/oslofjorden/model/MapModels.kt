...
data class PolylineData(val polylines: HashMap<List<LatLng>, OslofjordenPolyline>) : MergedData()
data class MarkerData(val markers: List<Marker>) : MergedData()

data class OslofjordenPolyline(val options: PolylineOptions, val title: String, val description: String, val url: String?)
